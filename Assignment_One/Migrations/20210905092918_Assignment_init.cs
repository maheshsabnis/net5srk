...
{
    public partial class Assignment_init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorProducts", x => new { x.ProductsProductId, x.VendorsVendorId });
                    table.ForeignKey(
                        name: "FK_VendorProducts_Products_ProductsProductId",
                        column: x => x.ProductsProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VendorProducts_Vendors_VendorsVendorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorProducts_VendorsVendorId",
